...
const list = [
    ...
    },
    {
        ...
        pages: ['container', 'color', 'typography', 'border', 'icon', 'button', 'link', 'radio',
    ...
    // [...document.getElementById('Components$Menu').querySelectorAll('.ant-menu-item a')].map(i => { const arr = i.href.split('/'); return arr[arr.length - 2]; })
    {
        ...
        pages: [
            ...
            "auto-complete-cn", "checkbox-cn", "cascader-cn", "date-picker-cn", "form-cn", 
            ...
            "timeline-cn", "tag-cn", "tabs-cn", "table-cn", "alert-cn", "drawer-cn", "modal-cn", "message-cn", 
